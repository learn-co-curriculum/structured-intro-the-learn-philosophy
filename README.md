...
learners! In this lesson, we want to talk about the Learn philosophy.
...
This is the beginning of the online Software Engineering course, where you will go
through everything from the basics of writing code to building full stack React
web applications.
...
We believe in your infinite capacity to learn. We do our best to offer a curriculum 
that is clear, digestible, engaging, challenging, and deep. The curriculum you'll 
encounter on Learn is rigorous and will demand that you be patient, resourceful, and
gritty.
